...
public class Client extends JFrame{
		...
		equals.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (operation[0]){
                    ...
                    try{
                        String response = String.valueOf(stub.div(getTempFirst(), getTempSecond()));
					...
					setTempSecond(Double.parseDouble(display.getText()));
					try{
                        String response = String.valueOf(stub.mul(getTempFirst(), getTempSecond()));
                        System.out.println("response: " + response); 
                        display.setText(response);   
                    } catch (Exception exc) {
                        System.err.println("Client exception: " + exc.toString());
					...
					setTempSecond(Double.parseDouble(display.getText()));
					try{
                        String response = String.valueOf(stub.sub(getTempFirst(), getTempSecond()));
                        System.out.println("response: " + response); 
                        display.setText(response);   
                    } catch (Exception exc) {
                        System.err.println("Client exception: " + exc.toString());
					...
					setTempSecond(Double.parseDouble(display.getText()));
					try{
                        String response = String.valueOf(stub.add(getTempFirst(), getTempSecond()));
                        System.out.println("response: " + response); 
                        display.setText(response);   
                    } catch (Exception exc) {
                        System.err.println("Client exception: " + exc.toString());
	...
	private void sendUI(Client app) {
